...
variable "plan" {
  description = "The name of the commercial plan to apply to the zone. One of `free`, `lite`, `pro`, `pro_plus`, `business`, `enterprise`, `partners_free`, `partners_pro`, `partners_business`, or `partners_enterprise`."
  type        = string
  default     = "free"
}
...
variable "h2_prioritization" {
  description = "Specify HTTP/2 prioritization behavior. One of `on`, `off`, or `custom`."
  type        = string
  default     = "off"
}

variable "image_resizing" {
  description = "Specify image resizing behavior. One of `on`, `off`, or `open`."
  type        = string
  default     = "off"
}
...
variable "polish" {
  description = "Specify stream encoding behavior. One of `off`, `lossless`, or `lossy`."
  type        = string
  default     = "off"
}
